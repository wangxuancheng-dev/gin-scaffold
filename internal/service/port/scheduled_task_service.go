...
type ScheduledTaskService interface {
	...
	Create(ctx context.Context, name, spec, command string, timeoutSec int, enabled bool) (*model.ScheduledTask, error)
	Update(ctx context.Context, id int64, name, spec, command *string, timeoutSec *int, enabled *bool) (*model.ScheduledTask, error)
